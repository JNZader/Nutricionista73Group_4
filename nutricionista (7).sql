...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-11-2023 a las 20:59:23
...
(15, 'desayuno', 'tostadas con mermelada', 350, 1),
...
(41, 'Sopa de tomate', 'Sopa de tomate REcaliente', 180, 1);
...
(74, 16, '2023-10-27', 110),
(75, 21, '2023-10-11', 55.8),
(78, 33, '2023-10-01', 10),
(79, 33, '2023-10-29', 12),
(80, 33, '2023-10-30', 16);
...
(21, 'Tratamiento jnz', 16, '2023-10-11', '2023-10-27', 90, 1),
...
(33, '1ad', 16, '2023-10-26', '2023-10-27', 100, 0),
(34, '11', 16, '2023-10-06', '2023-10-06', 12, 1),
(35, 'asfas', 16, '2023-10-11', '2023-10-11', 22, 1),
(36, 'gfd', 23, '2023-10-06', '2023-10-07', 23, 0),
(37, 'dd', 17, '2023-10-12', '2023-10-28', 123, 0),
(39, 'xxx', 33, '2023-10-01', '2023-10-29', 16, 1),
(40, 'kl', 16, '2023-11-01', '2023-11-16', 200, 1);
...
(117, 32, 21, 150, 'SNACK', 0),
(118, 22, 23, 8, 'ALMUERZO', 1),
(119, 15, 23, 4, 'DESAYUNO', 1),
(120, 22, 24, 8, 'ALMUERZO', 1),
(122, 15, 22, 7, 'ALMUERZO', 1),
(124, 22, 21, 63, 'ALMUERZO', 1),
(130, 15, 30, 4, 'DESAYUNO', 1),
(131, 22, 30, 33, 'ALMUERZO', 1),
(132, 15, 39, 6, 'DESAYUNO', 0),
(133, 22, 39, 3, 'ALMUERZO', 0),
(134, 15, 35, 34, 'DESAYUNO', 0),
(135, 15, 40, 25, 'DESAYUNO', 1),
(136, 15, 26, 25, 'DESAYUNO', 1);
...
('jnz', 123456711, 'sl 25500000', 353744444, 110, 16, 1),
('fghydfh', 45235, '', 124124, 66.9, 17, 1),
('Juan Pérez', 123456789, 'Calle A 123', 555111222, 71, 18, 1),
('Luisa González', 987654321, 'Calle B 456', 555333444, 66.4, 19, 1),
('Roberto Sánchez', 456789123, 'Calle C 789', 555555666, 81.7, 20, 1),
('Ana López', 654321987, 'Calle D 234', 555777888, 57, 21, 1),
('Pedro Ramírez', 321987654, 'Calle E 567', 555999000, 76.1, 22, 1),
('Carmen Torres', 789123456, 'Calle F 890', 555222333, 69.3, 23, 1),
('Diego Martínez', 987123456, 'Calle G 123', 555444555, 73.2, 24, 1),
('Sofía Rodríguez', 123987456, 'Calle H 456', 555666777, 61.7, 25, 1),
('Manuel Fernández', 654789321, 'Calle I 789', 555888999, 78.9, 26, 1),
('Laura García', 987654123, '', 555000111, 64, 27, 1),
('ass', 121212, '312cc', 123321, 333, 29, 1),
('xb bcb', 3252, 'dsfds', 324, 75, 32, 1),
('III', 3, '3', 3, 16, 33, 0),
('tru', 34256, 'sdfg325', 34562, 124, 34, 1),
('fgdaf', 35435, 'sdf', 2354, 12, 35, 1);
...
--
ALTER TABLE `comida`
  MODIFY `idComida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT de la tabla `consulta`
--
ALTER TABLE `consulta`
  MODIFY `idConsulta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT de la tabla `dieta`
--
ALTER TABLE `dieta`
  MODIFY `idDieta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de la tabla `dietacomida`
--
ALTER TABLE `dietacomida`
  MODIFY `idDietaComida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT de la tabla `paciente`
--
ALTER TABLE `paciente`
  MODIFY `idPaciente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
