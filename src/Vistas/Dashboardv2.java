...
public class Dashboardv2 extends javax.swing.JFrame {
    ...
    public Dashboardv2() {
        initComponents();
        InitContent();
        defaultColor = new Color(150, 200, 130);
        clickedColor = new Color(90, 140, 80);
    ...
    public void ShowJPanel(JPanel p) {
        ...
        jPContenedor.add(p, BorderLayout.CENTER);
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(150, 200, 130));
        ...
        jPanel3.setBackground(new java.awt.Color(150, 200, 130));
        jPanel3.setMaximumSize(new java.awt.Dimension(120, 720));
        jPanel3.setMinimumSize(new java.awt.Dimension(120, 720));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        updateButtonColors(jButton5);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ShowJPanel(new ViewBuscar());
        updateButtonColors(jButton6);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboardv2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dashboardv2().setVisible(true);
            }
        });
    }
